                ...
                <div class="d-flex flex-column justify-content-start align-items-start gap-2">
                    ...
                    <div class="update-input">
                        ...
                        function get_employees()
                        {
                            ...
                            $employee = '<select name="employee_name" class="update-input" style="width: 400px; height: 36px;">';
                    ...
                    <div class="d-flex flex-column justify-content-start align-items-start gap-2">
                        ...
                        <div class="update-input">
                            <input class="update-input" style="width: 400px; height: 36px;" type="text"
                                name="project_title" value="<?php echo $task->project_title; ?>">
                        </div>
                    </div>
                    <div class="d-flex flex-column justify-content-start align-items-start gap-2">
                        <label for="project_desc">Project Description</label>
                        <div class="update-input">
                            <textarea cols="51" rows="4" type="text" name="project_desc"
                                value="<?php echo $task->project_desc; ?>"><?php echo $task->project_desc; ?></textarea>
                        </div>
                    </div>
                    <div class="d-flex flex-column justify-content-start align-items-start gap-2">
                    ...
                    <div class="mt-2 d-flex justify-content-center align-items-center">
                        <button class="update-btn" style="width: 250px; margin-left: 90px;" type="submit" name="updatebtn">Update
                            Project</button>
                    </div>
                </div>
        </form>
